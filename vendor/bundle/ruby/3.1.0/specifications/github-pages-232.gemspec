...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.10.0"])
    ...
    s.add_runtime_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.5.1"])
    ...
    s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.16.2", "< 2.0"])
    ...
    s.add_dependency(%q<jekyll>.freeze, ["= 3.10.0"])
    ...
    s.add_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.5.1"])
    ...
    s.add_dependency(%q<nokogiri>.freeze, [">= 1.16.2", "< 2.0"])
